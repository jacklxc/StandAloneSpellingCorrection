...
def build_command(dependency):
	...
	--do_test false \
	--batch_size 8 \
	--init_pretraining_params ./checkpoints/vanilla_mix/latest \
	--num_labels 100005 \
	--chunk_scheme "IOB" \
	...
	--checkpoints ./checkpoints/vanilla_mix \
	--save_steps 2000 \
	--weight_decay 0.01 \
	...
	--for_cn false \
	--test_save ./ernie_corrector_prediction/vanilla_ernie_mix'

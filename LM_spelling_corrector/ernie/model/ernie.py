...
class charEncoder(object):
    def __init__(self,
        ...
        self._word_emb_name = "char_embedding"
        self._pos_emb_name = "char_pos_embedding"
        self._sent_emb_name = "char_sent_embedding"
        self._task_emb_name = "char_task_embedding"
        self._dtype = core.VarDesc.VarType.FP16 if use_fp16 else core.VarDesc.VarType.FP32
        self._emb_dtype = core.VarDesc.VarType.FP32
    ...
    def _build_model(self, src_ids, position_ids, sentence_ids, task_ids,
        ...
        emb_out = pre_process_layer(
            emb_out, 'nd', self._prepostprocess_dropout, name='char_pre_encoder')

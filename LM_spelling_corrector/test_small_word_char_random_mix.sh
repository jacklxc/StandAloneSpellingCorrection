...
python -u ./ernie/run_misspelling.py \
	...
	--do_test true \
	--batch_size 8 \
	--init_checkpoint ./checkpoints/small_word_char_mix/latest \
	--num_labels 100005 \
	--chunk_scheme "IOB" \
	...
	--for_cn false \
	--test_save ./ernie_corrector_prediction/word_char_small_mix_dev,./ernie_corrector_prediction/word_char_small_mix_test

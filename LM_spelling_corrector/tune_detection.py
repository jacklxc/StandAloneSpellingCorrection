...
def build_command(dependency):
    ...
    """
    n_gpu = 10
    job_name = "ERNIE_detection"
    partition = "2080Ti"
    cmd_str = 'python -u ./ernie/run_misspelling.py \
	--use_cuda true \
	--do_train true \
	--do_val true \
	--do_test false \
	--batch_size 8 \
	--init_pretraining_params ./checkpoints/detection/latest \
	--num_labels 3 \
	--chunk_scheme "IOB" \
	--label_map_config ${TASK_DATA_PATH}/label_map.json \
	--train_set ${TASK_DATA_PATH}/train_mix_detection.tsv \
	--dev_set ${TASK_DATA_PATH}/dev_detection.tsv,${TASK_DATA_PATH}/test_detection.tsv \
	--test_set ${TASK_DATA_PATH}/test_detection.tsv \
	--vocab_path ${MODEL_PATH}/vocab.txt \
	--ernie_config_path ${MODEL_PATH}/ernie_config.json \
	--checkpoints ./checkpoints/detection \
	--save_steps 1000 \
	--weight_decay 0.01 \
	...
	--for_cn false \
	--test_save ./ernie_corrector_prediction/new_ernie'

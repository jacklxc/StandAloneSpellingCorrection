...
python -u ./ernie/run_misspelling_char.py \
	--use_cuda true \
	--do_train false \
	--do_val false \
	--do_test true \
	--batch_size 8 \
	--init_checkpoint ./checkpoints/char_random/latest \
	...
	--ernie_config_path ${MODEL_PATH}/word_config.json \
	...
	--for_cn false \
	--test_save ./ernie_corrector_prediction/char_random_dev,./ernie_corrector_prediction/char_random_test

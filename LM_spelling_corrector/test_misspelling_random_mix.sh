...
python -u ./ernie/run_misspelling.py \
	...
	--do_test true \
	--batch_size 4 \
	--init_checkpoint ./checkpoints/random_natural_mix/latest \
	--num_labels 100005 \
	--chunk_scheme "IOB" \
	...
	--for_cn false \
	--test_save ./ernie_corrector_prediction/random_ernie_char_mix_dev,./ernie_corrector_prediction/random_ernie_char_mix_test
